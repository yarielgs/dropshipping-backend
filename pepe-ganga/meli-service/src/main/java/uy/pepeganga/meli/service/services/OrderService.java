                    ...
                    if (!meliOrderItemDtos.isEmpty() && !Objects.isNull(sellerAccount) && !Objects.isNull(sellerAccount.getProfile())) {
                        ordersDto.add(
                                OrderDto.builder()
                                        ...
                                        .department("")
                                        .rut(Long.parseLong(sellerAccount.getProfile().getRut() == null ? "0" : sellerAccount.getProfile().getRut()))
                                        .ci(sellerAccount.getProfile().getCi() == null ? 0 : sellerAccount.getProfile().getCi())
